    ...
    <div className="wrapper" id="projectS">
      ...
      <div className="project_container">
        ...
        <ProjectItem
          ...
          processDescriptions={["At the start of the project, we had multiple ideas including a smart mirror, an assistive living system, and a WoT-based well-being concept. One idea that stood out was an interactive art exhibition using emotion detection, where the visuals and audios would react to facial expressions. This concept evolved into our final direction: smArt – an AI-powered art installation that provides a fun, easy and interactive way to experience and learn about art.", "I was mainly responsible for front-end development. I implemented features such as art style selection and photo capture. I also added music and sound effects based on system states. A major technical achievement for me was integrating a WebSocket-based control interface, so users can interact with the system in real time with a remote. This helped tie the project directly to core WoT principles.", "The final prototype allowed users to select an art style of their choice, take a picture of themselves then see themselves in that art style with the help with OpenAI's API. "]}
